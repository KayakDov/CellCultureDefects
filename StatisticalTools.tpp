...
double StatisticalTools<Iterator>::mean(const UnaryFunc& f) const{
...
template<typename Iterator>
template<typename UnaryFunc>
double  StatisticalTools<Iterator>::variance(const UnaryFunc& f) const{
    double avg = mean(f);
